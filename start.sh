...
PORT="${PORT:-4960}"
DB_NAME="${PGDATABASE:-maritime_port_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Maritime Port Operations Suite"
echo "======================================="
echo
...
echo "Starting maritime port operations suite frontend on http://localhost:$PORT"
echo "Login: admin@maritime-port-operations.local / admin123"
